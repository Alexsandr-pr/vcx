...
<section class="carousel">
    ...
    <!-- функция добавления постов с админки wp kama -->
<?php
global $post;
...
?>
        ...
        <div class="carousel__item">
            <div class="carousel__item-box">
              <!-- кастомный картинки, возможность добавления через админ вордпрес -->
                ...
                <!-- кастомные заголовки через админку -->
                <h4 class="carousel__item-title"><?php the_title(); ?></h4>
                <!-- кастомный контент через админку -->
